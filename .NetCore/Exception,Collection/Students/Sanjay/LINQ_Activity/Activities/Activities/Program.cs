    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            static void DisplayAllTour(List<TourPackage> packages)
            {
                ...
                {
                    Console.WriteLine(tours.TourId + " | " +
                                      tours.TourName + " | " +
                                      tours.Destination + " | " +
                                      tours.Price);
                }
            ...
            static void OrderByRank(List<TourPackage> packages)
            {
                ...
                {
                    Console.WriteLine("Rank: " + count1 + " | "
                                        + item.TourName + " | "
                                        + item.Destination + " | "
                                        + item.Price);
                    //Console.WriteLine("Destination: " + item.Destination);
                    //Console.WriteLine("Rank" + count1 + item.Price);
                    count1++;
                }
            }
            ...
            static void TourSearch(List<TourPackage> packages)
            {
                ...
                TourPackage to = packages.FirstOrDefault(t => t.TourName.ToLower().Contains(names.ToLower()));
