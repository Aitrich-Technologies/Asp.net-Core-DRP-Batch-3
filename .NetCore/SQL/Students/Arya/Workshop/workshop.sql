create database TourBookingPortal;
use  TourBookingPortal;
...
INSERT INTO Destinations ([Name], City, [Description], CreatedBy)
VALUES (
'seoul korea exploring', 
'Korea', 
'A beautiful cherryblossom & jeju island',
 (SELECT Id FROM [Users] WHERE UserName = 'skyhigh
 travel')
);
